...
async function predictPic(imagePath) {
  try {
    ...
    if (predictedClass === 0) {
      ...
      handling = "Green trash bins are designated for organic waste, so you can dispose of this type of organic waste in the green garbage cans. Besides that, there are several options to manage the organic waste in the following ways : 1. Composting : Composting is a simple and effective way to handle organic waste. You can create a compost pile or use a compost bin in your backyard or garden. By collecting food scraps, yard trimmings, and other organic materials, you can create nutrient-rich compost that can be used to fertilize plants and gardens. Collaborate with neighbors, local organizations, or waste management agencies to establish shared composting facilities in your community. This can help optimize resource utilization and promote a circular economy. 2. Home Vermicomposting : Vermicomposting is an excellent option for smaller living spaces, such as apartments or houses with limited outdoor areas. You can set up a worm composting bin indoors using special composting worms (such as red wigglers) to break down organic waste. The resulting worm castings can be used as a nutrient-rich soil amendment for houseplants or balcony gardens. 3. Farmers Markets and Organic Farms : Some farmers markets or organic farms in Indonesia may accept organic waste for composting purposes. These organizations often have their own composting systems and can make good use of additional organic materials. Reach out to local farmers markets or organic farms to inquire if they accept organic waste donations. 4. Biogas Production : Consider setting up a biogas system for larger organic waste volumes. Biogas is produced through anaerobic digestion of organic waste and can be used as a renewable energy source for cooking or electricity generation. Remember, it is important to separate organic waste from other types of waste, such as plastics or metals, to ensure proper recycling and disposal. By responsibly managing your organic waste, you can contribute to reducing the overall waste burden, promoting sustainable practices, and nurturing a healthier environment in Indonesia!";
      ...
      handling = "Yellow trash bins are designated for inorganic waste, so you can dispose of this type of waste in the yellow garbage cans. In addition, you can manage inorganic waste in the following ways : 1. Recycling : Identify recyclable materials within your inorganic waste, such as plastic bottles, paper, cardboard, glass, and metals. Check with local recycling centers or waste management companies to find out where you can deliver these materials for recycling. Support local recycling initiatives and encourage others to do the same. 2. Electronic Waste Collection: For electronic waste, including old appliances, computers, and mobile phones, it is important to dispose of them properly to prevent environmental contamination. Look for e-waste collection points or authorized electronic waste recycling companies in your area. They specialize in handling electronic waste and ensure that hazardous components are managed safely. 3. Donations and Reuse: Consider donating or reusing items that are still in good condition instead of throwing them away. For example, you can repurpose glass jars as storage containers or use old newspapers for wrapping items. Donate or sell items that are still in good condition to extend their lifespan. This approach helps reduce waste and extends the lifespan of usable items. Remember, it is essential to separate inorganic waste from organic waste to ensure proper recycling and disposal. Additionally, practicing waste reduction and conscious consumption by minimizing the use of single-use plastics and packaging can significantly contribute to reducing the volume of inorganic waste generated.";
